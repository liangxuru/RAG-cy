...
class Pipeline:
    ...
    def download_docling_models(): 
        ...
        parser = PDFParser(output_dir=PROJECT_ROOT)
        parser.parse_and_export(input_doc_paths=[PROJECT_ROOT / "src/dummy_report.pdf"])
...
if __name__ == "__main__":
    ...
    root_path = PROJECT_ROOT / "data" / "stock_data"
